    ...
    <div class="container-fluid">
        ...
        <div class="col">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="RoomTb" runat="server" readonly />
                    </div>
                   
                    <div class="mb-3">
                        <label for="AmountTb" class="form-label">Amount</label>
                        <input type="text" class="form-control" id="AmountTb" runat="server" readonly />
                    </div>
                    </div>
                    <div class="col-4">
                         <div class="mb-3">
            ...
            <div class="col mt-3">
             ...
             <asp:GridView ID="BookingGV" runat="server" class="table" CellPadding="2" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="BookingGV_SelectedIndexChanged">
